...
{
    public partial class update_cource : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("update cources set title=@title, description=@desc, instructor=@instructor, capacity=@cap where title=@title", con);
            ...
            cmd.Parameters.AddWithValue("@cap",txt_capacity.Text);
            cmd.ExecuteNonQuery();
            lblMessage.ForeColor = System.Drawing.Color.Green;
            lblMessage.Text = "Updated Succesful";
        }
    }
}